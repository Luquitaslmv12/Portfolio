...
export default function SobreMi() {
  return (
    <motion.section
      ...
      className="bg-gray-900 py-10 px-6 rounded-2xl shadow-xl max-w-3xl mx-auto flex flex-col items-center"
    >
      ...
      <h2 className="text-2xl font-bold text-white mb-2">Sobre mí</h2>

      <p className="text-center text-lg text-gray-300 italic max-w-xl">
