  ...
  return (
    <motion.section
      ...
      className="relative min-h-screen flex flex-col justify-center items-center text-center px-6 sm:px-8
          bg-gradient-to-b from-blue-900 via-slate to-black
    ...
    >
      <header className="w-full max-w-3xl mx-auto">
        ...
        <motion.p
          ...
          className="text-lg md:text-xl text-gray-300 max-w-xl mx-auto mb-6 font-medium"
        >
          Desarrollador Freelancer enfocado en crear experiencias digitales
      ...
      <motion.button
        ...
        className="bg-cyan-500 dark:bg-cyan-600 text-white font-semibold px-6 py-3 rounded-full 
      ...
      <motion.svg
        ...
        className="w-12 h-12 text-cyan-400 mx-auto absolute bottom-24 hidden md:block cursor-pointer"
        fill="none"
        stroke="currentColor"
        strokeWidth="2"
        viewBox="0 0 24 24"
